...
const ProductCardList = () => {
  ...
  return (
    <div>
      ...
      <a href=""><div className="w-6 h-6 flex flex-col-2 flex-wrap gap-1">
      ...
      <a href=""><div className="w-8 h-6 flex flex-col-2 flex-wrap gap-1">
        <div className="w-2 h-2 bg-gray-600"></div>
        <div className="w-2 h-2 bg-gray-600"></div>
        <div className="w-2 h-2 bg-gray-600"></div>
        <div className="w-2 h-2 bg-gray-600"></div>
      ...
      <a href=""><div className="w-12 h-6 flex flex-col-2 flex-wrap gap-1">
        <div className="w-2 h-2 bg-gray-600"></div>
        <div className="w-2 h-2 bg-gray-600"></div>
        <div className="w-2 h-2 bg-gray-600"></div>
        <div className="w-2 h-2 bg-gray-600"></div>
