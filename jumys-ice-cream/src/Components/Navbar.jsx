        ...
        <div className="absolute shadow-xl bg-white z-50 rounded-lg text-black h-[450px] w-[1000px] pt-5">
          <div className="flex justify-around">
            <div className="space-y-2 mt-5">
              ...
              <i className="text-gray-400 block hover:text-red-500">Shop Standard</i>
              <i className="text-gray-400 block hover:text-red-500">Shop Full</i>
              <i className="text-gray-400 block hover:text-red-500">Shop Only Category</i>
              <i className="text-gray-400 block hover:text-red-500">Shop Icon Category</i>
              <i className="text-gray-400 block hover:text-red-500">Shop Image Category</i>
              <i className="text-gray-400 block hover:text-red-500">Shop Image Category 2</i>
              <i className="text-gray-400 block hover:text-red-500">Shop Sub Category</i>
            ...
            <div className="space-y-3 mt-5">
              ...
              <i className="text-gray-400 block hover:text-red-500">Filter Side Out</i>
              <i className="text-gray-400 block hover:text-red-500">Filter DropDown</i>
              <i className="text-gray-400 block hover:text-red-500">Filter On Top</i>
              <i className="text-gray-400 block hover:text-red-500">Filter Drawer</i>
              <div className="space-y-3 mt-5">
                <h1 className="font-bold text-[20px]">Shop Loader</h1>
                <i className="text-gray-400 block hover:text-red-500">Shop Pagination</i>
                <i className="text-gray-400 block hover:text-red-500">Shop Infinity</i>
                <i className="text-gray-400 block hover:text-red-500">Shop Load More</i>
              </div>
            </div>
            <div className="space-y-2 mt-5">
              <h1 className="font-bold text-[20px]">Hover Style</h1>
              <i className="text-gray-400 block hover:text-red-500">Icon On Hover</i>
              <i className="text-gray-400 block hover:text-red-500">Quick View Button</i>
              <i className="text-gray-400 block hover:text-red-500">Add To Cart Button</i>
              <i className="text-gray-400 block hover:text-red-500">WhishList Icon</i>
              <i className="text-gray-400 block hover:text-red-500">Quick Shop Light</i>
              <div className="space-y-2 mt-5">
                <h1 className="font-bold text-[20px]">Woo Pages</h1>
                <i className="text-gray-400 block hover:text-red-500">Order Tracking</i>
            ...
            <div className="space-y-2 mt-5">
              ...
              <i className="text-gray-400 block hover:text-red-500">Side Out Light</i>
              <i className="text-gray-400 block hover:text-red-500">Side Out Dark</i>
              ...
              <div className="space-y-2 mt-5">
                ...
                <i className="text-gray-400 block hover:text-red-500">Check out Classis</i>
                <i className="text-gray-400 block hover:text-red-500">Check out Modern</i>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="">
      <ul className="set-font flex justify-center">
        <div className="absolute shadow-xl bg-white z-50 rounded-lg text-black h-[450px] w-[1000px] pt-5">
              ...
              <div className="space-y-2 mt-5">                <h1 className="font-bold text-[20px]">Product Featured</h1>                <i to="" className="text-gray-500 block hover:text-red-500">Sticky Add TO Cart</i>                <i to="" className="text-gray-500 block hover:text-red-500">Video Inner </i>                <i to="" className="text-gray-500 block hover:text-red-500">Video PopUp</i>                <i to="" className="text-gray-500 block hover:text-red-500">360 Degree</i>                <i to="" className="text-gray-500 block hover:text-red-500">CountDown</i>                <i to="" className="text-gray-500 block hover:text-red-500">Buy Together</i>                <i to="" className="text-gray-500 block hover:text-red-500">Notify Me</i>                <i to="" className="text-gray-500 block hover:text-red-500">Real Time Visitor</i>                <i to="" className="text-gray-500 block hover:text-red-500">Products Recently Viewed</i>                <i to="" className="text-gray-500 block hover:text-red-500">trust Badge </i>                <i to="" className="text-gray-500 block hover:text-red-500">Pre Order_Product</i>              </div>              <div className="space-y-3 mt-5">                <h1 className="font-bold text-[20px]">Product Type</h1>                <NavLink to="/Simple-Product" className="text-gray-950 block hover:text-red-500" onClick={closeAllDropdowns}>Simple Product</NavLink>                <i to="" className="text-gray-500 block hover:text-red-500">Simple Slider</i>                <i to="" className="text-gray-500 block hover:text-red-500">Group Product</i>                <i to="" className="text-gray-500 block hover:text-red-500">Variable Product</i>                <i to="" className="text-gray-500 block hover:text-red-500">External & Affiliat Product</i>                <i to="" className="text-gray-500 block hover:text-red-500">Sold Out</i>                <div className="space-y-3 mt-5">                  <h1 className="font-bold text-[20px]">Zoom Effect</h1>                  <i to="" className="text-gray-500 block hover:text-red-500">AutoZoom </i>                  <i to="" className="text-gray-500 block hover:text-red-500">Lens Zoom </i>                  <i to="" className="text-gray-500 block hover:text-red-500">Magic Zoom</i>                </div>              </div>
              <div className="space-y-2 mt-5">
  ...
  return (
    <div>
      <div className='w-full h-28 flex gap-2 justify-around' id='layout'>
        <div className='w-11 h-full flex justify-center items-center text-[30px]' id='menuBar' onClick={toggleMenu}>
          <FaBars />
        </div>
        ...
        <div className='w-[600px] h-full flex items-center justify-around font-semibold' id='pages'>
          <div onMouseEnter={() => setDropdownVisible(true)} onMouseLeave={() => setDropdownVisible(false)} className='w-[90px]'>
            <NavLink to="/" className='flex' id='underline-animate' onClick={closeAllDropdowns}>Home<FaAngleDown className='mt-[5px] ml-1' /></NavLink>
            {dropdownVisible && HomeMenu()}
          </div>
          <div onMouseEnter={() => setShopdownVisible(true)} onMouseLeave={() => setShopdownVisible(false)} className='w-[90px]'>
            <a  className='flex' id='underline-animate'>Shop<FaAngleDown className='mt-[5px] ml-1' /></a>
            {shopdownVisible && ShopMenu()}
          </div>
          <div onMouseEnter={() => setProductdownVisible(true)} onMouseLeave={() => setProductdownVisible(false)} className='w-[90px]'>
            <a className='flex' id='underline-animate'>Products<FaAngleDown className='mt-[5px] ml-1' /></a>
            {productdownVisible && ProductMenu()}
          </div>
          <div onMouseEnter={() => setBlogdownVisible(true)} onMouseLeave={() => setBlogdownVisible(false)} className='w-[90px]'>
            <a className='flex' id='underline-animate'>Blog<FaAngleDown className='mt-[5px] ml-1' /></a>
            {blogdownVisible && BlogMenu()}
          </div>
          <div onMouseEnter={() => setPagedownVisible(true)} onMouseLeave={() => setPagedownVisible(false)} className='w-[90px]'>
            <a className='flex' id='underline-animate'>Page<FaAngleDown className='mt-[5px] ml-1' /></a>
            {pagedownVisible && PageMenu()}
          </div>
        </div>

        <div className='w-[190px] h-full flex justify-around items-center text-[22px]' id='icons'>
          <NavLink to='/login' className='icon2 text-red'><FaUser /></NavLink>
          <NavLink to='/wishlist' className='icon3 text-red'><FaHeart /></NavLink>
          <NavLink to='/cart' className='icon4 text-red'><FaShoppingBasket /></NavLink>
        </div>
      </div>
        ...
        <div className="menu-toggle">
          <div className="menu">
            <ul>
              ...
              <li><NavLink to="/blogCard" onClick={toggleMenu}>Blog card </NavLink></li>
              <li><NavLink to="/faq2" onClick={toggleMenu}>Faq 2 </NavLink></li>
              <li><NavLink to="/error" onClick={toggleMenu}>Page 404</NavLink></li>
            </ul>
          </div>
        </div>
      )}
      ...
      <div className='w-full h-[80px] fixed bottom-0 flex justify-around bg-white z-20' id='header-footer'>
        {/* Footer content */}
        <div className='w-full h-[80px] fixed bottom-0 flex justify-around bg-white z-20' id='header-footer'>
         <NavLink to="/shop" className='w-24 h-full flex flex-col justify-center items-center text-red'><FaGripVertical className='text-[30px]' /><p>Shop</p></NavLink>
         <NavLink to="/login" className='w-24 h-full flex flex-col justify-center items-center text-red'><FaUser className='text-[30px]' /><p>Account</p></NavLink>
         <NavLink to="/wishlist" className='w-24 h-full flex flex-col justify-center items-center text-red'><FaHeart className='text-[30px]' /><p>Wishlist</p></NavLink>
       </div>
      </div>
