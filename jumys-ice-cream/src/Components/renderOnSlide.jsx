                    ...
                    return (
                        <div className="d-flex flex-wrap">
                            {data.map((product) => {
                                ...
                                return (
                                    <Card style={{ width: '18rem', margin: '10px' }} key={product.name}>
                                        <div
                                            className='w-[380px] h-[350px] hover:opacity-90'
                                            onMouseEnter={() => setImage(product.img2)}
                                            onMouseLeave={() => setImage(product.img1)}
                                        >
                                            <div className='w-full h-full'>
                                                <Card.Img className='w-[350px] h-[350px] rounded-2xl' variant="top" src={image} alt={product.name} />
                                                <IconMenu />
                                            </div>
                                        </div>
                                        <Card.Body>
