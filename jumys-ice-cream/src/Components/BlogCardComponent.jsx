...
const BlogCardComponent = (props) => {
  return (
    <>
      <div className='w-1/4 h-[350px] pb-3 overflow-hidden' id='blog-image'>
      ...
      <img className='w-full h-[350px]' id='blog-image' src={props.img} alt="not found" />
      <div className='slide-top w-full drop-shadow-2xl px-9 -mt-[150px] relative bottom-10' id='shadow-effect'>
