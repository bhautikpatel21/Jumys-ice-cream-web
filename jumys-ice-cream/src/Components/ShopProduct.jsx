...
const ShopProduct = ({ selectedColor, minPrice, maxPrice, selectedSize, selectedProductId }) => {
  ...
  // Function to simulate data loading when filters change
  useEffect(() => {
    setLoading(true);
    const timeout = setTimeout(() => {
      setLoading(false); // Stop loading animation after data is filtered
  ...
  return (
    <div>
      ...
      {showProductCardList ? (
        ...
        // Display a loading spinner when filtering is in progress
